    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active info" href="<?= base_url('criar/dados_dre') ?>">
          ...
          <span class="nav-link-text ms-1">Criar DRE</span>
        </a>
      </li>

      <!-- Visualizar DRE -->
      <li class="nav-item">
        <a class="nav-link active info" href="<?= base_url('criar/dre') ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md text-center me-2 d-flex align-items-center justify-content-center"
               style="width:40px; height:40px;">
            <i class="bi bi-file-earmark-text-fill text-white fs-5"></i>
          </div>
          <span class="nav-link-text ms-1">Visualizar DRE</span>
        </a>
      </li>

      <?php elseif ($this->usuario->is_logado()): ?>
      <!-- Cadastrar empresa -->
      <li class="nav-item">
      ...
      <!-- Sair -->
      <li class="nav-item">
        <a class="nav-link active info" href="<?= base_url('conta/sair') ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md text-center me-2 d-flex align-items-center justify-content-center"
               style="width:40px; height:40px;">
